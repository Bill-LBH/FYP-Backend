...
public class ArcSoft {
    ...
    public static FaceEngine faceEngine(){
        //        从官网获取
        String appId = "AiSCKqbfr291giKkdvSXWPMSKgn2K9ZvmZK1Btu8jnLY";
        String sdkKey = "7QAqxKFWXmmfJxuSNNBkNiTCzXgo8QFcKXMgPGDbekDM";
        FaceEngine faceEngine = new FaceEngine("C:\\Users\\LinBo\\Downloads\\ArcSoft_ArcFace_Java_Windows_x64_V3.0\\libs\\WIN64");
